...
namespace Oculus.Interaction
{
    ...
    /// </summary>
    public class TranslateTransformerNetworked : NetworkBehaviour, ITransformer
    {
        [Serializable]
        ...
        private void RPC_SetNewLocalOffset(Vector3 grabOffsetInLocalSpace)
        {
            _grabOffsetInLocalSpace = grabOffsetInLocalSpace;
        }

        public void EndTransform()
        {
            RPC_SetNewLocalOffset(_grabOffsetInLocalSpace);
        }
        #region Inject
