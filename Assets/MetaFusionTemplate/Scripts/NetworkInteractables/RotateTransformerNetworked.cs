...
namespace Oculus.Interaction
{
    ...
    /// </summary>
    public class RotateTransformerNetworked : NetworkBehaviour, ITransformer
    {
        public enum Axis
        {
            Right = 0,
        ...
        private void RPC_SetNewAngles(float constrainedRelativeAngle, float relativeAngle)
        {
            _constrainedRelativeAngle = constrainedRelativeAngle;
        }

        public void EndTransform()
        {
            RPC_SetNewAngles(_constrainedRelativeAngle, _relativeAngle);
        }
        #region Inject
